...
export default function App(){
  ...
  return(<div style={s.page}>
    <div style={s.header}><div><div style={s.title}>🖼️ UltraNFT</div><div style={{fontSize:13,color:"#64748b"}}>On-chain NFT minting • {total?.toString()??0} minted</div></div><ConnectButton/></div>
